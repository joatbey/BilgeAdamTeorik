...
//		okul.siniflariYazdir();
		...
		okul2.sinifEkle(new Sinif("1B","Zemin Kat 108 nolu oda"));
		//yukarıdaki gibi yaptık.
		//okuldan sınıfa nasıl ulaşabiliriz ? Okul sınıfının içinde bir listte duruyor 
		
		Sinif snf = okul2.getSinif("1A"); // 1 A sınıfına baklım.
		if(snf != null) {
			snf.sinifaOgrenciEkle("Tolga", "Kayan", 111, 0);
