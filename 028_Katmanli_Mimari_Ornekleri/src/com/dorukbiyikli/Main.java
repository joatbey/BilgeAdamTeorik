...
import com.dorukbiyikli.controller.OgrenciController;
import com.dorukbiyikli.controller.OgretmenController;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (secim) {
			case 1:
				// DataBase.ogrenciListesi.add(new Ogrenci(null, null, secim)) // boyle yaparsak
